          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              foreach ($customer as $row) {
                ...
                if ($row['verifyed'] == 0) {
                  echo '<a href="' . site_url("admin") . '/customer/verify/' . $row['id'] . '" class="btn btn-sm btn-success" onclick="javascript:verify(' . $row['id'] . ')" data-toggle="tooltip" title="Verify" id="btnVerify"><span class="glyphicon glyphicon-ok"></span></a>';
                } else {
